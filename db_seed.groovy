...
meta_gender_male = g.addV('meta').property('name', 'gender').property('value', 'male').next()
meta_gender_female = g.addV('meta').property('name', 'gender').property('value', 'female').next()
meta_age_53 = g.addV('meta').property('name', 'age').property('value', 53).next()
meta_age_23 = g.addV('meta').property('name', 'age').property('value', 23).next()
...
g.addE('tags').from(meta_gender_male).to(oca_sb_c).next()
g.addE('tags').from(meta_gender_female).to(oca_sb_d).next()
g.addE('tags').from(meta_age_53).to(oca_sb_c).next()
g.addE('tags').from(meta_age_23).to(oca_sb_d).next()

g.addE('describes').from(meta_gender_male).to(entity_1).next()
g.addE('describes').from(meta_gender_male).to(entity_3).next()
g.addE('describes').from(meta_age_53).to(entity_1).next()
g.addE('describes').from(meta_gender_female).to(entity_2).next()
g.addE('describes').from(meta_age_23).to(entity_2).next()
g.addE('describes').from(meta_age_23).to(entity_3).next()
